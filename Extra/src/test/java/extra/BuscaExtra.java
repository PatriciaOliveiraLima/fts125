...
public class BuscaExtra {
	...
	public void Print(String nomePrint) throws IOException {
		...
		FileUtils.copyFile(foto, new File ("C:\\Users\\patri\\FTS125-workspace\\Extra\\target\\evidencias\\"+ nomePasta + "\\"+ nomePrint +".png"));
	}
	...
	public void Iniciar() {
		...
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\patri\\FTS125-workspace\\Extra\\drivers\\chrome\\79\\chromedriver.exe");
		driver = new ChromeDriver();
		driver.manage().timeouts().implicitlyWait(120000, TimeUnit.MILLISECONDS); // Comando para calibrar o tempo de espera de resposta 
	...
	public void exibe_a_mensagem_de_produto_nao_encontrado() throws Throwable {
		...
		//assertEquals("smartphone", driver.findElement(By.cssSelector("ul.neemu-breadcrumb-container")).getText());
		Print("Passo 3.n - Não há resultados para a busca");
	}
